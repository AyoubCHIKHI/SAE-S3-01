        ...
        <div class="flex flex-col md:flex-row items-center">
            ...
            <article class="flex-1 flex flex-col items-center ">
                <div class="flex items-center gap-x-4 py-8">
                    <label for="toggle_don" class="text-base text-gray-700">Je donne une fois</label>
                    ...
                    <label for="toggle_don" class="text-base text-gray-700">Je donne tous les mois</label>
                </div>
