<nav class="sticky flex justify-between w-full bg-white/80 backdrop-blur-md top-0 z-50 shadow px-8 py-4 transition-transform duration-300">
    ...
    <a href="/index.php" class="flex-shrink-0">
        <img src="/assets/img/Logo.svg" alt="EGEE Logo" class="w-48  transform transition duration-300 hover:scale-105 hover:shadow-lg rounded-lg">
    </a>

    <div class="hidden md:flex gap-8 lg:gap-6 pt-4 mx-auto whitespace-nowrap text-gray-500">
        ...
        <a href="#" id="ouvrir-don" class="flex gap-1 hover:text-red-500 transition-colors">
    ...
    <img src="/assets/img/icon_menu_burger.svg" alt="icon_menu_burger" class="md:hidden w-8 mr-4 ml-auto transition transform hover:scale-125 cursor-pointer">
</nav>
