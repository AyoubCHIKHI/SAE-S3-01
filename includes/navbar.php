<div class="relative">
    ...
    <div class="fixed inset-0 bg-white z-50 transform translate-x-full peer-checked:translate-x-0 transition-transform duration-300 flex flex-col p-8 gap-6 overflow-y-auto">
